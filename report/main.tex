...
% TODO: justificar el tipus de grafic triat (Tufte: tipus de dades)

\begin{figure}[h!]
  \centering
  \fbox{\parbox[c][4cm][c]{0.75\linewidth}{\centering \small [Captura del redisseny]}}
  \caption{Redisseny proposat: [eina/llibreria].}
  \label{fig:redisseny}
\end{figure}

\subsection{Interactivitat implementada}
\begin{itemize}
  \item \textbf{[Tipologia 1]:} ...
  \item \textbf{[Tipologia 2]:} ...
\end{itemize}

% =========================================================
\section{Annex tecnic}

\textbf{Repositori de codi:} \url{https://github.com/USUARI/REPO}

\textbf{Eines emprades:} ...
