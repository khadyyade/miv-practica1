...
% Modelitzacio i Visualitzacio de Dades -URV 
% =========================================================
...
El gràfic el va publicar el compte oficial \textbf{@Esquerra\_ERC} a X (Twitter) el
\textbf{30 de març de 2024}, en plena \textbf{campanya} per a les eleccions al
Parlament de Catalunya del 12 de maig de 2024. ERC governava, i el gràfic formava part d'una sèrie de publicacions que
presentaven xifres de gestió econòmica del Govern com a argument de campanya. El missatge
que pretenia transmetre és que el pressupost de la Generalitat havia crescut de
manera \textbf{espectacular} sota ERC per justificar la seva continuïtat. Aquest missatge no una peça informativa neutra. Notem una comparació de
només tres punts(2003, 2020 i 2024) i un eix sense escala: és una decisió que
serveix directament l'objectiu persuasiu de la publicació.

\begin{figure}[h!]
  \centering
  \fbox{\includegraphics[width=0.50\linewidth]{misleading-chart.png}}
    \caption{Gràfic publicat per @Esquerra\_ERC a X el 30 de març de 2024,
      comparant el pressupost inicial de la Generalitat de 2003 amb el de 2024. Consultar \href{https://x.com/Esquerra_ERC/status/1767926450135384275/photo/1}{aquí}}
  \label{fig:original}
\end{figure}
...
llegint la seva \href{https://www.idescat.cat/indicadors/?id=aec&n=15638}{pàgina}. En contrastar anys solapats amb la font primària s'ha detectat una desviació
...
Tufte, això demana un gràfic de línies. Una línia deixa veure la trajectòria, que és precisament el que el gràfic original
...
\begin{figure}[h!]
  \centering
  \fbox{\includegraphics[width=0.9\linewidth]{modified-chart.png}}
...
\begin{figure}[h!]
  \centering
  \fbox{\includegraphics[width=0.9\linewidth]{modified-chart_1.png}}
...
\begin{itemize}\footnotesize
  \item \texttt{docs/nova-practica-miv.pdf}: Enunciat original de la pràctica.
  \item \texttt{data/pressupost\_generalitat\_2003\_2024.csv}: Dataset reconstruït
  \item \texttt{src/build\_dataset.py}: Codi de la reconstrucció i generació del dataset.
  \item \texttt{src/plot\_design.py}: Aplicació Streamlit + Plotly del redisseny interactiu.
  \item \texttt{requirements.txt}: Dependències de Python.
  \item \texttt{report/main.tex} i \texttt{report/main.pdf}: Aquest informe, font i compilat.
  \item \texttt{report/img/}: Imatges utilitzades en aquest informe.
\end{itemize}

\textbf{Per reproduir-ho} (des de l'arrel del repositori):
\begin{enumerate}\footnotesize
  \item \texttt{pip install -r requirements.txt}
  \item \texttt{python3 src/build\_dataset.py}: Descarrega les dades en directe de l'API i regenera el CSV a \texttt{data/} (cal connexió a internet).
  \item \texttt{streamlit run src/plot\_design.py}: Obre l'aplicació interactiva al navegador.
\end{enumerate}
